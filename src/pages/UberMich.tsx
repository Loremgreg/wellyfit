        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg mb-12 text-muted-foreground leading-relaxed">
              Mehrjährige Praxis mit Einsteigern, Berufstätigen, Sportlern und Senioren. Ich höre zu, erkläre verständlich und bleibe an Ihrer Seite – vom ersten Kennenlernen bis zu Ihren Erfolgen.
            </p>
          </div>
        </div>
      </section>
