        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-heading font-bold mb-6">
              Wellness‑Massage – Anfrageformular
            </h1>
            <p className="text-lg mb-8 text-primary-foreground/90">
              Melden Sie sich an, um Ihre <strong>Wellness‑Massage bei Ihnen zu Hause</strong> zu buchen. 
              Ich komme zu Ihnen (Murnau am Staffelsee & Umgebung) und gestalte die Massage entspannt, 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-primary">
                      Ihre Verfügbarkeiten (mehrere Optionen möglich)
                    </h3>
            ...
            <div className="space-y-6">
              ...
              <Card className="card-elegant">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <p>• Ich melde mich innerhalb von 48 Stunden</p>
